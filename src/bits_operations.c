...
void usage(void)
{
    ...
    fprintf(stdout, "Cette algorithme utilise le codage d'Huffman\n");
    fprintf(stdout, "Si vous voulez essayer de coder/decoder votre fichier\n");
    fprintf(stdout, "Je vous invite d'abord a lire README.md fichier\n");
}
